...
function productsCollection(array $codes): array
{
    ...
    return [
        ...
        'fields' => [
            ...
            ['name' => 'memory', 'label' => 'Remembers past conversations', 'type' => 'boolean', 'default' => false, 'description' => 'A filter in the comparison table on the homepage.'],
            ['name' => 'voice', 'label' => 'Voice messages or calls', 'type' => 'boolean', 'default' => false, 'description' => 'A filter in the comparison table on the homepage.'],
            ['name' => 'nsfw', 'label' => 'Allows NSFW content', 'type' => 'boolean', 'default' => false, 'description' => 'A filter in the comparison table on the homepage.'],
