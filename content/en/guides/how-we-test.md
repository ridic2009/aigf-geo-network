...
status: published
type: guide
translation_key: how-we-test
date: 2026-01-20
updated: 2026-09-18
author: m-keller
reviewer: s-moreau
intro: >
  Every score on this site comes from a paid account and at least two weeks of
  daily chat. This is the method, including what we cannot see from the outside.
products:
  - candy-ai
  - nomi
  - sweetdream
faq:
  - question: How long do you test each app?
    answer: >
      At least two weeks of daily use on a paid plan. Memory and pricing only
      show up at that timescale.
  - question: Can a company buy a better score?
    answer: >
      No. Scores are locked before commercial contact. Affiliate commissions
      never move a rating.
  - question: Why five criteria, not seven?
    answer: >
      Conversation, memory, media, price and controls cover what readers
...
seo:
  title: How We Test AI Girlfriend Apps
  description: "Our method: paid accounts, two-week tests, five scores, hidden
    costs, and privacy checks. Rankings are not for sale."
  primary_keyword: how we test ai girlfriend apps
indexing:
  index: true
  follow: true
---
...
Sticker prices lie. I check intro versus renewal, whether images burn tokens on top of the subscription, and whether the free tier is a product or a trailer. The longer write-up is [what these apps really cost](/guides/what-ai-girlfriend-apps-really-cost/).
