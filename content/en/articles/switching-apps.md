---
title: Switching AI Companion Apps Without Starting From Zero
slug: switching-ai-companion-apps
status: published
type: article
category: choosing
...
faq:
  ...
  - question: Should I cancel the old app first?
    answer: >
      No. Overlap by a week. You need the old app live to copy from, and you
      will want the comparison while both are in front of you.
  - question: Will the new character feel the same?
    answer: >
      Close, if you carry the speech style across, and it usually improves
      within a week as the new app accumulates its own history.
related:
...
indexing:
  ...
  follow: true
---
There is no export format in this category and there will not be one. Nobody has
an incentive to make leaving easy, and no standard exists to adopt even if they
did.
...
The order matters, and it is the opposite of what people do.

### 1. Copy the character out verbatim
...
paste a dozen replies you thought were characteristic into the file. You will
use them as a style sample later.
...
Not everything. Five or six exchanges that were the reason you stayed. They are
your reference for whether the new app is actually worse or merely different.
...
### 5. Save the images you want

Generated pictures live on their servers. Download what you want to keep.
...
you over a month, state the important ones plainly in the first session:
"Remember: I work nights, my sister is Ana, I hate being asked how my day was."
Stored-fact systems pick up explicit statements far more reliably than implied
ones.

**Give it a week before judging.** A new companion on day one is competing
against one with months of accumulated history. That is not a fair comparison,
and almost everyone makes it anyway.

## Overlap, do not jump

Keep both running for a week. You need the old one live to copy from, and the
side-by-side is the only way to tell whether you are actually getting what you
switched for.

A week of two subscriptions costs $10–20. Cancelling first, discovering the new
app is worse, and rebuilding from nothing costs considerably more in the only
currency that matters here, which is the weeks of history you threw away.
...
The reasons that genuinely justify a move are structural, and they are the ones
...
Each of those is a property of the product. Everything else is worth one more
week of fixing before you pay a signup fee somewhere new.
...
appeal is mostly its present behaviour rather than its archive. For some it is
the whole thing, and those people are usually better served by fixing the app
they have.
