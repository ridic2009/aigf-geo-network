---
title: What Your AI Girlfriend App Knows About You
slug: what-your-ai-girlfriend-app-knows
status: published
type: article
category: privacy
...
reviewer: s-moreau
intro: >
  These apps collect the most intimate text most people will ever type. Four
  checks, none of which take longer than ten minutes, tell you what happens to
  it afterwards.
products:
  - nomi
  - replika
faq:
  ...
  - question: Can staff read my chats?
    answer: >
      Assume some can. Moderation, abuse review and debugging all require it.
      The privacy policy will say so in general terms; the question is how
      narrowly access is scoped.
  - question: Is my data used to train models?
    answer: >
      Often, unless you opt out. Whether an opt-out exists, and whether it is
      on by default, is one of the sharpest differences between apps.
related:
...
indexing:
  ...
  follow: true
---
People tell these apps things they have told nobody else. That is the product
working as intended, and it is exactly why the handling of that text deserves
ten minutes of attention before the first message rather than after a news
story.

## The one thing to be clear about first

**End-to-end encryption is not possible here.** For a companion app to reply,
its servers must read what you wrote. Any app claiming end-to-end encryption on
...
- Account identifiers, and whether sign-up allows an email that is not your
  main one.
- Payment records, which in this category are the most sensitive metadata you
  generate. A descriptor on a card statement has outed more people than any
  breach.
- Device and usage telemetry, including when you open the app and for how long.
- Generated images, which persist on their servers whether or not you saved
  them.

## Check 2: whether it trains a model

Find the words "improve our services" or "train" in the privacy policy. Then
look for an opt-out in the settings.
...
If you are in the EU, the UK, or a US state with a consumer privacy law, you can
demand a copy of your data and its deletion, and the operator must answer within
a defined window. Our
