---
title: How to Read an AI Girlfriend App's Feature List
slug: reading-ai-girlfriend-feature-lists
status: published
type: article
category: choosing
...
reviewer: s-moreau
intro: >
  Eight apps, near-identical bullet points, wildly different products. Here is
  what each of the standard claims can mean, and the question that settles it.
products:
  - nomi
  - kupid
faq:
  - question: Why do all these apps list the same features?
    answer: >
      Because the bullets describe categories rather than implementations.
      "Memory" covers everything from a six-item list to a system that survives
      months, and both are truthfully described by the same word.
  ...
  - question: Is a longer feature list better?
    answer: >
      ...
      things properly beats one listing nine.
related:
...
indexing:
  ...
  follow: true
---
Put the pricing pages of eight AI companion apps side by side and they converge
on the same dozen bullets. The apps behind them are not remotely the same. Each
claim below is technically true in every case and hides a range wide enough to
decide whether you enjoy the product.
...
that is pleasant for a week and one that is pleasant in month four. The
mechanics are in
[how AI companion memory works](/articles/ai-companion-memory-explained/).

**The question that settles it:** *can I see and edit what it has stored?* An
...
the expensive part of these apps is not text. [Images and voice cost the
operator real money per use](/articles/how-ai-companion-media-works/), so that
is where the meter goes.

**The question:** *unlimited what, exactly, and what still costs credits?*
...
Real-time calls are expensive, usually on an upper tier, and stand or fall on
latency: a three-second gap before every answer destroys the effect.

**The question:** *is it a call or a voice note, and what is the delay?*
...
**The question:** *where is the line, and has it moved recently?* Details in
[content filters](/articles/ai-companion-content-filters/).
...
Depth here correlates with how long the app stays interesting, because a
character you built is one you can rebuild when it goes stale.
[Camsoda AI](/reviews/camsoda-ai-review/) is built around a six-step builder;
that is a genuine product difference, not a bullet point.

**The question:** *can I edit the character after creating it, or only at
setup?*
...
**The question:** *what actually changes at level five, in words?*

## "Free tier"

Every app we track has one. The range is between a product you could use for
