---
title: Telling People You Use an AI Companion
slug: talking-about-your-ai-companion
status: published
type: article
category: wellbeing
translation_key: talking-about-it
date: 2026-09-21
updated: 2026-09-21
author: m-keller
reviewer: s-moreau
intro: >
  The question comes up more often than people expect, usually at the least
  convenient moment. Deciding in advance what you think about it is worth more
  than any particular script.
products:
  - replika
  - sweetdream
faq:
  - question: Do I have to tell my partner?
    answer: >
  ...
  - question: How do people usually react?
    answer: >
      ...
      the discomfort people brace for is usually about a fear of loneliness
      rather than the app.
  - question: Should I mention it on a dating profile?
    answer: >
      There is no obligation. It is a hobby, not a disclosure, and it is a lot
      to put in front of someone who has not met you yet.
related:
...
indexing:
  ...
  follow: true
---
There is no etiquette here yet. The technology arrived faster than any shared
sense of what it means, which is why the question feels loaded out of proportion
to the activity.

What follows is not a rule. It is the small number of distinctions that make the
decision easier.

## The test that settles most of it

Forget whether it is "cheating" or "weird" in the abstract. Those arguments have
no resolution and people mostly use them to reach a conclusion they already had.
...
That single question resolves the partner case more reliably than any argument
about categories.

## If you have a partner

The strongest reason to say something is unglamorous: discovery is worse than
disclosure, every time. A phone left unlocked, a lock-screen notification, a
line on a shared bank statement. The practicalities are in
[payment privacy](/articles/ai-girlfriend-payment-privacy/) and
[using a shared device](/articles/ai-companion-shared-device/), but no amount of
setup removes the risk entirely.

If you do raise it, two things help:

**Lead with what it is, not with a defence.** "I've been using one of those AI
chat apps, it's a bit like a game" starts a conversation. An unprompted
...
novel you talk to, and it costs about the same as a streaming subscription.

The people who react badly are usually reacting to a picture of loneliness
rather than to you. That is [worth its own
consideration](/articles/ai-companions-and-loneliness/), but it is not a reason
to lie.
...
Describe the activity rather than the relationship. "I use an AI chat app" lands
...
## Where the honest discomfort lives

One case is worth separating out, because being straightforward about it is more
...
Most people are not in that case. Most people use one of these apps a few
evenings a week and the only awkwardness is a conversational one, which fades
fast.

## The sentence that usually does it
